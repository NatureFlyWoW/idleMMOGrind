...
export enum EngineEventType {
  ...
  ELITE_AREA_UNLOCKED = 'event:elite-area-unlocked',
  RARE_SPAWN_APPEARED = 'event:rare-spawn-appeared',
  RARE_SPAWN_DEFEATED = 'event:rare-spawn-defeated',
  ZONE_EVENT_STARTED = 'event:zone-event-started',
  ZONE_EVENT_EXPIRED = 'event:zone-event-expired',
